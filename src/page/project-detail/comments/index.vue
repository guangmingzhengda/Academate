...
export default {
    ...
    async mounted() {
        ...
        this.totComments = {
            total: 15,
            commentList: [
                { id: 1, userId: 101, account: 'Alice', content: '这是一个非常有见地的项目，期待最终成果！', time: '2024-07-20 10:30', replyId: null, isDel: false, avatar: 'https://i.pravatar.cc/150?img=1' },
                { id: 2, userId: 102, account: 'Bob', content: '关于数据收集部分，你们是如何保证隐私的？', time: '2024-07-20 11:15', replyId: null, isDel: false, avatar: 'https://i.pravatar.cc/150?img=2' },
                { id: 3, userId: 101, account: 'Alice', content: '我们采用了匿名化和数据加密技术，确保所有数据都符合隐私保护法规。', time: '2024-07-20 11:45', replyId: 2, isDel: false, avatar: 'https://i.pravatar.cc/150?img=1' },
                { id: 4, userId: 103, account: 'Charlie', content: '这个项目的研究方法很新颖，值得借鉴。', time: '2024-07-21 09:00', replyId: null, isDel: false, avatar: 'https://i.pravatar.cc/150?img=3' },
                { id: 5, userId: 104, account: 'David', content: '请问项目有计划开源部分代码吗？', time: '2024-07-21 14:20', replyId: null, isDel: false, avatar: 'https://i.pravatar.cc/150?img=4' },
                { id: 6, userId: 105, account: 'Eve', content: '回复#4：谢谢你的认可，我们会继续努力的！', time: '2024-07-21 16:00', replyId: 4, isDel: false, avatar: 'https://i.pravatar.cc/150?img=5' },
                { id: 7, userId: 106, account: 'Frank', content: '源评论已删除的测试。', time: '2024-07-22 10:00', replyId: 99, isDel: false, avatar: 'https://i.pravatar.cc/150?img=6' }, // replyId 99 does not exist
                { id: 8, userId: 107, account: 'Grace', content: '项目的UI设计很棒，用户体验很好。', time: '2024-07-22 11:00', replyId: null, isDel: false, avatar: 'https://i.pravatar.cc/150?img=7' },
                { id: 9, userId: 108, account: 'Heidi', content: '这个评论已经被删除了。', time: '2024-07-22 12:00', replyId: null, isDel: true, avatar: 'https://i.pravatar.cc/150?img=8' },
                { id: 10, userId: 109, account: 'Ivan', content: '回复一个已被删除的评论。', time: '2024-07-22 13:00', replyId: 9, isDel: false, avatar: 'https://i.pravatar.cc/150?img=9' },
                { id: 11, userId: 110, account: 'Judy', content: '这个项目看起来很有前途。', time: '2024-07-23 09:30', replyId: null, isDel: false, avatar: 'https://i.pravatar.cc/150?img=10' },
                { id: 12, userId: 111, account: 'Mallory', content: '建议增加一个数据可视化的模块。', time: '2024-07-23 10:45', replyId: null, isDel: false, avatar: 'https://i.pravatar.cc/150?img=11' },
                { id: 13, userId: 101, account: 'Alice', content: '好主意，我们正在考虑这个功能！', time: '2024-07-23 11:50', replyId: 12, isDel: false, avatar: 'https://i.pravatar.cc/150?img=1' },
                { id: 14, userId: 112, account: 'Niaj', content: '请问你们用的是什么技术栈？', time: '2024-07-24 15:00', replyId: null, isDel: false, avatar: 'https://i.pravatar.cc/150?img=12' },
                { id: 15, userId: 113, account: 'Olivia', content: '超长评论测试，超长评论测试，超长评论测试，超长评论测试，超长评论测试，超长评论测试，超长评论测试，超长评论测试，超长评论测试，超长评论测试，超长评论测试，超长评论测试，超长评论测试，超长评论测试，超长评论测试，超长评论测试。', time: '2024-07-24 16:00', replyId: null, isDel: false, avatar: 'https://i.pravatar.cc/150?img=13' },
            ]
        };
    ...
    methods: {
        ...
        beforeComment(id) {
            ...
            if(this.role !== 'creator' && this.role !== 'participant') {
                this.loginVisible = true;
                return;
            }
        ...
        commitComment(id) {
            ...
            console.log(`Comment committed to ${id}: ${this.userInput}`);
            this.userInput = "";
            callSuccess("评论成功（静态）");
            // setTimeout(() => {
            //     location.reload();
